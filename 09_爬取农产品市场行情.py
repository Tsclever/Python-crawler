...
# 学成归来！
# 攻克 北京新发地
# 网站地址：http://www.xinfadi.com.cn/index.html
import requests

url = "http://www.xinfadi.com.cn/getCat.html"

print("请选择对应编号：蔬菜:1186 水果:1187 肉禽蛋:1188 水产:1189 粮油:1190 豆制品:1203 调料:1204")
choice = input("请输入编号：")
...
resp = requests.post(url, headers=headers, params=parms)
data = resp.json()

for i in data['list']:
  print("品名：", i['prodName'])
  print("最低价：", i['lowPrice'])
  print("平均价：", i['avgPrice'])
  print("最高价：", i['highPrice'])
  print("产地：", i['place'])
  print("单位：", i['unitInfo'])
  print("发布日期：", i['pubDate'])
  print("========================================================")